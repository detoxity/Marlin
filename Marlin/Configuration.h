...
#define TEMP_HYSTERESIS         13  // (°C) Temperature proximity considered "close enough" to the target
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 510 }
...
//#define Z_SERVO_ANGLES { 20, 100 } // Z Servo Deploy and Stow angles
